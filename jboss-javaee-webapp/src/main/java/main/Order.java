...
public class Order {
    ...
    @ManyToMany
    @JoinTable(
        name = "order_meal",  // Name of the join table
        joinColumns = @JoinColumn(name = "order_id"),  // Column name in the join table referencing the Order entity
        inverseJoinColumns = @JoinColumn(name = "meal_id")  // Column name in the join table referencing the Meal entity
    )
